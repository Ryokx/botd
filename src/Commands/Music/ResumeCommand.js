...
module.exports = class ResumeCommand extends Command {
  ...
  async exec(msg) {
    try {
      ...
      if (!msg.member.voice.channelId) return msg.channel.send({ embeds: [CreateEmbed('warn', '⛔ | vous devez rejoindre un canal vocal pour faire cela.')] });
      if (msg.member.voice.channelId !== GuildPlayers.voiceChannel) return msg.channel.send({ embeds: [CreateEmbed('warn', '⛔ | vous devez rejoindre le même canal vocal que moi pour faire cela.')] });
