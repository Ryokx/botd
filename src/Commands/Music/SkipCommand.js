...
module.exports = class SkipCommand extends Command {
  ...
  async exec(msg) {
    try {
      ...
      GuildPlayers.stop();
      return msg.channel.send({ embeds: [CreateEmbed('info', '👌 | Enleve cette musique de merde !')] });
    } catch (e) {
      this.client.logger.error(e.message);
      return msg.channel.send({ embeds: [CreateEmbed('warn', '⛔ | Ca ne fonctionne pas ')] });
    }
  }
  ...
  async executeSlash(interaction) {
    try {
      ...
      GuildPlayers.stop();
      return interaction.editReply({ embeds: [CreateEmbed('info', '👌 | Enleve cette musique de merde !')] });
    } catch (e) {
      this.client.logger.error(e.message);
      return interaction.editReply({ embeds: [CreateEmbed('warn', '⛔ | Ca ne fonctionne pas !')] });
    }
  }
};
